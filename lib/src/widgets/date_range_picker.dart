...
const CalendarTheme kTheme = CalendarTheme(
  selectedColor:Color(0xff475DA1),
  dayNameTextStyle: TextStyle(color: Colors.black45, fontSize: 10),
  inRangeColor: Color(0xFFD9EDFA),
  inRangeTextStyle: TextStyle(color: Color(0xff475DA1)),
...
class DateRangePickerWidgetState extends State<DateRangePickerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      width: widget.doubleMonth == true  ? MediaQuery.of(context).size.width * 0.9 :  MediaQuery.of(context).size.width * 0.5,
      child: Column(
        children: [
          child,
